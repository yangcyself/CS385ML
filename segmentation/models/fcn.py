...
from models.alexnet import alexnet_encoder
...
def fcn_8(n_classes, encoder=alexnet_encoder, input_height=416, input_width=608):
...
def fcn_32(n_classes, encoder=alexnet_encoder, input_height=416, input_width=608):
...
def fcn_8_alexnet(n_classes, input_height=224, input_width=224):
	model = fcn_8(n_classes, alexnet_encoder, input_height=input_height, input_width=input_width)
	model.model_name = "fcn_8_alexnet"
	return model

def fcn_32_alexnet(n_classes, input_height=224, input_width=224):
	model = fcn_32(n_classes, alexnet_encoder, input_height=input_height, input_width=input_width)
	model.model_name = "fcn_32_alexnet"
	return model
