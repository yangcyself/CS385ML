...
from config import IMAGE_ORDERING, DATA_PATH
from data_utils.augmentation import augment_seg
import random
...
def get_pairs_from_paths(images_path, segs_path):
    ...
    for im in images:
        ...
        if seg in segmentations:
            ret.append((im, seg))
        else:
            print(im + " is present in " + images_path + " but " + seg_bnme +
                    " is not found in " + segs_path +
